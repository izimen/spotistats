...
const TopArtistCard = React.memo(({ rank, name, image, delay = 0, spotifyUrl }: TopArtistCardProps) => {
  const isTop3 = rank <= 3;
    ...
    >
      ...
      <div className="relative flex items-center gap-3">
        ...
        <div className="relative flex-shrink-0" style={{ transform: 'translateZ(10px)' }}>
          ...
          `}>
            <div className="w-8 h-8 rounded-full bg-[#1DB954] flex items-center justify-center shadow-lg shadow-[#1DB954]/40 scale-90 group-hover:scale-100 transition-transform">
        ...
        {spotifyUrl && (
          <div className="flex-shrink-0 opacity-0 group-hover:opacity-100 transition-opacity">
            <div className="w-8 h-8 rounded-full flex items-center justify-center text-[#1DB954] hover:bg-[#1DB954]/10 transition-colors">
